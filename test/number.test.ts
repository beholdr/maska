...
test('fraction number unmasked', () => {
  ...
  expect(mask.unmasked('1234567.10')).toBe('1234567.1')
  expect(mask.unmasked('1234567.109')).toBe('1234567.1')
  expect(mask.unmasked('1234567.0')).toBe('1234567')
...
test('handle masked/unmasked for custom locales', () => {
  const brMask = new Mask({ number: { locale: 'pt-BR', fraction: 2 } })

  expect(brMask.unmasked('1.234,56')).toBe('1234.56')
  expect(brMask.masked(brMask.unmasked('1.234,56'))).toBe('1.234,56')
  expect(brMask.masked(brMask.unmasked('1.234,1'))).toBe('1.234,1')
  expect(brMask.masked(brMask.unmasked('1.234,01'))).toBe('1.234,01')
  expect(brMask.masked(brMask.unmasked('1.234,10'))).toBe('1.234,1')
  expect(brMask.masked(brMask.unmasked('1.234,109'))).toBe('1.234,1')
  expect(brMask.masked(brMask.unmasked('1,23'))).toBe('1,23')

  const deMask = new Mask({ number: { locale: 'de', fraction: 3 } })

  expect(deMask.unmasked('1.234,56')).toBe('1234.56')
  expect(deMask.masked(deMask.unmasked('1.234,56'))).toBe('1.234,56')
  expect(deMask.masked(deMask.unmasked('1.234,1'))).toBe('1.234,1')
  expect(deMask.masked(deMask.unmasked('1.234,01'))).toBe('1.234,01')
  expect(deMask.masked(deMask.unmasked('1.234,10'))).toBe('1.234,1')
  expect(deMask.masked(deMask.unmasked('1.234,1009'))).toBe('1.234,1')
  expect(deMask.masked(deMask.unmasked('1,23'))).toBe('1,23')
})
